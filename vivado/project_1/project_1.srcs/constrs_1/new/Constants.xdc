...
##LEDs
set_property -dict { PACKAGE_PIN M14   IOSTANDARD LVCMOS33 } [get_ports { led_done }]; #IO_L23P_T3_35 Sch=led[0]
...
set_property -dict { PACKAGE_PIN V15   IOSTANDARD LVCMOS33     } [get_ports { cc_csn  }]; #IO_L10P_T1_34 Sch=jc_p[1]
set_property -dict { PACKAGE_PIN W15   IOSTANDARD LVCMOS33     } [get_ports { cc_mosi }]; #IO_L10N_T1_34 Sch=jc_n[1]
set_property -dict { PACKAGE_PIN T11   IOSTANDARD LVCMOS33     } [get_ports { cc_miso }]; #IO_L1P_T0_34 Sch=jc_p[2]
set_property -dict { PACKAGE_PIN T10   IOSTANDARD LVCMOS33     } [get_ports { cc_sclk }]; #IO_L1N_T0_34 Sch=jc_n[2]
